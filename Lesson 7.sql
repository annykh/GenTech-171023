...
select first_name, last_name, age
from user_berlin;
-- Получаем дубликаты, чтобы вывести только уникальные значения после объединения используем union. 

-- Union позволяет объединить две однотипных выборки.
select  first_name, last_name, age
from user_bremen
union
select first_name, last_name, age
...
select title, null as price, quantity
from goods1
union 
...
-- имя_таблицы.имя_столбца
 ...
 join regions -- объедняем с таблицей ...
